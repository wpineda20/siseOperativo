    ...
    <v-dialog v-model="dialog" max-width="600px" persistent>
      <v-card class="flexcard" height="100%">
        ...
        <v-col cols="12" sm="12" md="6">
            <base-input
            label="Año de inicio"
            v-model="$v.editedItem.start_year.$model"
            :validation="$v.editedItem.start_year"
            validationTextType="none"
            :validationsInput="{
                required: true,
                minLength: true,
        ...
        <v-col cols="12" sm="12" md="6">
            <base-input
            label="Año de fin"
            v-model="$v.editedItem.end_year.$model"
            :validation="$v.editedItem.end_year"
            validationTextType="none"
            :validationsInput="{
                required: true,
                minLength: true,
